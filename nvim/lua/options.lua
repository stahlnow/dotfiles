...
o.winborder   = 'rounded'             -- show a rounded border around floating windows
...
vim.g.markdown_fenced_languages = { 'html', 'python', 'lua', 'c', 'cpp', 'asm', 'bash', 'make', 'man', 'rust', 'go',
   'typescript', 'javascript', 'django', 'glsl' }
