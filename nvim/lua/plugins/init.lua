return {
   ...
   -- https://github.com/zbirenbaum/copilot.lua
   {
      ...
      config = function()
         require("copilot").setup(require "plugins.config.copilot".config)
      end,
      keys = require "plugins.config.copilot".mappings,
   },
   ...
   -- https://github.com/Robitx/gp.nvim
   {
      "robitx/gp.nvim",
      config = function()
         require("gp").setup(require "plugins.config.gpt".config)
      end,
      keys = require "plugins.config.gpt".mappings,
   },
